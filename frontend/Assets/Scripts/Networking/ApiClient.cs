...
namespace BlackVault.Networking
{
    ...
    public class ApiClient : MonoBehaviour
    {
        ...
        {
            StartCoroutine(PostRequest<PreprocessResponse>("/preprocess", JsonUtility.ToJson(data), onSuccess, onError));
        }

        public void SendTrainRequest(TrainRequest data, Action<TrainResponse> onSuccess, Action<string> onError)
        {
            StartCoroutine(PostRequest<TrainResponse>("/train", JsonUtility.ToJson(data), onSuccess, onError));
        }

        public void SendCorruptRequest(CorruptRequest data, Action<CorruptResponse> onSuccess, Action<string> onError)
        {
            StartCoroutine(PostRequest<CorruptResponse>("/corrupt", JsonUtility.ToJson(data), onSuccess, onError));
        }
        
        public void GetPlayerProgress(Action<PlayerProgressResponse> onSuccess, Action<string> onError)
        {
            StartCoroutine(GetRequest<PlayerProgressResponse>("/player/progress", onSuccess, onError));
        }
